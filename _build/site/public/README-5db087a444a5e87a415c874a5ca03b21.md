...
Once again each of these teams are extremely close with one another. The Milwaukee Bucks and the  are tied for the highest TS% with 61.5. But like always, the Boston celtics are not far off with their 60.1 TS%. Since all of these teams have a similar shooting percentage there is one final statistic that is arguably the most important.
